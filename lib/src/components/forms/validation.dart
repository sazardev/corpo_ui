...
abstract final class CorpoValidation {
  ...
  static String? Function(String?) required([String? message]) => (String? value) {
  ...
  static String? Function(String?) minLength(int min, [String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  static String? Function(String?) maxLength(int max, [String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  /// Validates that field matches another field (useful for password confirmation).
  static String? Function(String?) matches(String? other, [String? message]) => (String? value) {
      if (value != other) {
  ...
  static String? Function(String?) numeric([String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  static String? Function(String?) integer([String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  static String? Function(String?) min(double minimum, [String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  static String? Function(String?) max(double maximum, [String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  static String? Function(String?) pattern(RegExp regex, [String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
  ...
  /// Validates strong password (at least 8 chars, contains uppercase, lowercase, number).
  static String? Function(String?) strongPassword([String? message]) => (String? value) {
      if (value == null || value.isEmpty) return null;
